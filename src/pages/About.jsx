...
const About = () => {
    return (
        <div className='container mx-auto md:flex justify-between items-center bg-[#494b50] rounded-tl-[150px] rounded-br-[150px] py-24 gap-8 lg:gap-0'>
            ...
            <div className='px-12 mt-5 lg:mt-0 lg:pr-12 lg:ml-24'>
                ...
                <p className='text-xl'>I am Ajoy Biswas. I am a front-End developer.<br/> I can create website with Javascript and React js</p>
